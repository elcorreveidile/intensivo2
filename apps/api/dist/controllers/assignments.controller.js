...
exports.deleteAssignment = exports.updateAssignment = exports.createAssignment = exports.getAssignment = exports.getAssignments = void 0;
...
const createAssignment = async (req, res) => {
    try {
        ...
        const courseId = typeof req.params.courseId === 'string' ? req.params.courseId : req.params.courseId[0];
        const { title, description, instructions, dueDate, maxScore = 100, allowedFileTypes = ['pdf', 'docx', 'mp3', 'mp4'], maxFileSizeMb = 100, allowLateSubmission = false, rubric, attachments, } = req.body;
        // Validation
        ...
        const lastAssignment = await prisma_1.prisma.assignment.findFirst({
            where: { courseId },
...
const updateAssignment = async (req, res) => {
    try {
        ...
        const id = typeof req.params.id === 'string' ? req.params.id : req.params.id[0];
        const { title, description, instructions, dueDate, maxScore, allowedFileTypes, maxFileSizeMb, allowLateSubmission, rubric, attachments, } = req.body;
...
const deleteAssignment = async (req, res) => {
    try {
        ...
        const submissionCount = await prisma_1.prisma.submission.count({
