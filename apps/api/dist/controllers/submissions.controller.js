...
exports.getProfessorStats = exports.deleteFile = exports.uploadFile = exports.submitAssignment = exports.createOrUpdateSubmission = exports.getMySubmission = exports.getSubmissionsForAssignment = exports.getSubmission = void 0;
const prisma_1 = require("../prisma");
const utils_1 = require("../lib/utils");
// Get submission by ID
const getSubmission = async (req, res) => {
    try {
        const id = (0, utils_1.getIdParam)(req.params);
...
const uploadFile = async (req, res) => {
    try {
        ...
        const file = await prisma_1.prisma.submissionFile.create({
            data: {
                submissionId,
...
const deleteFile = async (req, res) => {
    try {
        ...
        // Get file
        const file = await prisma_1.prisma.submissionFile.findUnique({
            where: { id: fileId },
            include: {
                submission: true,
            },
        ...
        await prisma_1.prisma.submissionFile.delete({
            where: { id: fileId },
        });
...
const getProfessorStats = async (req, res) => {
    try {
        ...
        const allSubmissions = await prisma_1.prisma.submission.findMany({
            where: {
