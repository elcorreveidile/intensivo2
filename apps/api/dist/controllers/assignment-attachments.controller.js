...
const uploadAttachment = async (req, res) => {
    try {
        ...
        const attachment = await prisma_1.prisma.assignmentAttachment.create({
            data: {
                assignmentId,
...
const getAttachments = async (req, res) => {
    try {
        const assignmentId = typeof req.params.assignmentId === "string" ? req.params.assignmentId : req.params.assignmentId[0];
        const attachments = await prisma_1.prisma.assignmentAttachment.findMany({
            where: { assignmentId },
...
const deleteAttachment = async (req, res) => {
    try {
        ...
        // Get attachment
        const attachment = await prisma_1.prisma.assignmentAttachment.findUnique({
        ...
        await prisma_1.prisma.assignmentAttachment.delete({
            where: { id: attachmentId },
        });
...
//# sourceMappingURL=assignment-attachments.controller.js.map